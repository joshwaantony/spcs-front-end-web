        ...
        <div className="flex min-h-full items-center justify-center">
          <div className="w-full max-w-lg overflow-hidden rounded-[32px] border border-white/70 bg-[#fffaf9] shadow-[0_40px_120px_-40px_rgba(20,24,16,0.45)]">
            ...
            <div className="space-y-5 p-6 sm:p-8">
              <div className="overflow-hidden rounded-[24px] border border-[#f1e2dc] bg-[#fff5f2]">
                {notification.notification_image_url ? (
                  ...
                  <div className="flex h-[200px] items-center justify-center text-sm font-semibold text-[#b16a5b]">
                    No image
                  </div>
                )}
              </div>
              ...
              <div className="rounded-[24px] border border-[#f6ddd7] bg-[#fff3f0] px-5 py-4">
                ...
                <p className="mt-2 break-all text-xs text-[#7b6f6b]">
